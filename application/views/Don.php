...
<body style=" font-family: 'Montserrat';">
	<div class="page-wrapper">
				...
				<div class="aside-dropdown__item d-lg-none d-block">
					<ul class="aside-menu">
						...
						<li class="aside-menu__item aside-menu__item--has-child"><a class="aside-menu__link"
								href="index.html"><span>Accueil</span></a>
							<!-- sub menu start-->
							
							<!-- sub menu end-->
						</li>
						<li class="aside-menu__item aside-menu__item--has-child"><a class="aside-menu__link"
							href="#QuiSommeNous"><span>A Propos de Nous</span></a>
							<!-- sub menu start-->
						
							<!-- sub menu end-->
						</li>
						<li class="aside-menu__item aside-menu__item--has-child"><a class="aside-menu__link"
							href="#Participer"><span>Participer à une action</span></a>
						</li>
						<li class="aside-menu__item"><a class="aside-menu__link"
								href="#Contact1"><span>Contact</span></a></li>
					</ul>
				</div>
				<div class="aside-dropdown__item">
					<!-- aside menu start-->
					<ul class="aside-menu">
						<li class="aside-menu__item"><a class="aside-menu__link" href="#">Humanitaire</a></li>
						<li class="aside-menu__item"><a class="aside-menu__link" href="#">C.L.E.S</a></li>
						<li class="aside-menu__item"><a class="aside-menu__link" href="#">Cultuel</a></li>
					</ul>
					<!-- aside menu end-->
					<div class="aside-inner"><span class="aside-inner__title">Email</span><a class="aside-inner__link"
							href="mailto:support@helpo.org">Bureau@centre-des-lumieres.fr</a></div>
		...
		<div class="top-bar d-none d-lg-block">
			<div class="container-fluid">
				<div class="row align-items-end">
					<div class="col-lg-9"><a class="top-bar__link" href="tel:06 72 23 00 00">06 72 23 00 00</a><a
							class="top-bar__link"
							href="mailto:Bureau@centre-des-lumieres.fr">Bureau@centre-des-lumieres.fr</a></div>
			...
			<div class="container-fluid">
				...
				<div class="row no-gutters justify-content-between">
					<div class="col-auto d-flex align-items-center">
						...
						<div class="header-logo"><a class="header-logo__link" href="index.html"><img class="header-logo__img logo--light" src="img/logo_white.png" alt="logo" style="visibility: hidden;"><img class="header-logo__img logo--dark" src="img/Humanitaire.png" alt="logo"></a></div>
					</div>
					<div class="col-auto">
						<!-- main menu start-->
						<nav>
							<ul class="main-menu">
								...
								<li id="Accueil" class="main-menu__item main-menu__item--has-child main-menu__item--active"><a
										class="main-menu__link" href="Index.html"><span>Accueil</span></a>
								</li>
								...
								<li id="Horaire" class="main-menu__item main-menu__item--has-child
											"><a class="main-menu__link" href="#QuiSommeNous"><span>Horaire de prière</span></a>
								</li>
								
								<li id="Contact" class="main-menu__item main-menu__item--has-child"><a class="main-menu__link"
										href="#Contact1"><span>Contact</span></a>
								
								</li>
								<li id="participer" class="main-menu__item main-menu__item--has-child"><a class="main-menu__link" href="#Participer"><span
									class="button button--squared" href="#Participer">Je calcule ma ZAKAT</span></a>
		...
		<section class="promo-primary">
			<picture>
				<source srcset="img/about.jpg" media="(min-width: 992px)" /><img class="img--bg" style="height: 80%;" src="img/about.jpg"
					alt="img" />
			</picture>
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-xl-12 text-center m-3">
							<h2 class="subscribe__title" style="letter-spacing: 0.6px;color: black;">Les aumônes sont destinées aux pauvres, aux nécessiteux,
								 à ceux qui sont chargés de la collecter, 
								 à ceux dont les cœurs sont à gagner, 
								 au rachat des captifs, aux insolvables, à ceux qui se consacrent à la cause d'Allâh et aux voyageurs. 
								</h2>
						</div>
						<div class="col-xl-12 text-center mb-3">(Coran, S.9 V.60)</div>
					</div>
					<hr>
				</div>
				...
				<div class="container">
					<div class="row align-items-center">
						<div class="col-lg-6 col-xl-5">
							<div class="heading heading--primary"><span class="heading__pre-title">Qui
									sommes-nous</span>
								<h2 class="heading__title"><span>LE CULTUEL</span> </h2>
							</div>
							<p>En tant qu’acteur humanitaire de premier plan, on est habilité à collecter votre Zakât
								puis à la relayer aux ayants-droits dans le respect de l’éthique musulmane.
								En France comme dans nos nombreux pays d’intervention, tels que la Syrie, le Pakistan,
								la Palestine ou encore le Mali, nous venons en aide à des millions de personnes.
								Précaires, elles font toutes partie individuellement comme collectivement de celles qui
								peuvent légitimement bénéficier de votre Zakât.
							</p>
							<p>
						</div>
			...
			<section class="section action-section">
				<div class="jarallax">
					<picture>
						<source srcset="img/imgbg.png" media="(min-width: 992px)" /><img class="jarallax-img"
							src="img/ZAKAT.png" alt="img" />
					</picture>
				</div>
				<div class="container" id="Participer">
					<div class="row">
						<div class="col-12 text-center"><i class="fas fa-quote-left fa-3x"style="color: #ffff;"></i></div>
						<div class="col-12 text-center">
							<h2 class="action-section__title">« Prélève de leurs biens une aumône par laquelle tu les
								purifie et les bénis… »</h2>
							<p class="action-section__text">
								(Coran, S.9 V.103)</p>
							<br>
							
							<a class="button button-zakat m-2" data-toggle="modal" id="modaleCalcul" data-target=".bd-example-modal-lg"
								
								href="#">Je paie ma Zakat</a>
							<a class="button button-zakat m-2" data-toggle="modal" data-target=".bd-example-modal-lg2"
							
								href="#">Je verse ma Zakat</a>
			...
			<div class="container-fluid m-0 p-0 ">
				...
				<div class="row">
					<div class="col-12 text-center">
						...
						<a data-masjidbox-widget="ID6crA6jGgyg-1JnGcGmq" data-masjidbox-ifr
							href="https://masjidbox.com/prayer-times/test-1624359354113">Prayer times test</a>
						...
						<div class="modal fade bd-example-modal-lg" id="myModal" tabindex="-1" role="dialog"
							...
							<div class="modal-dialog modal-lg">
								<div class="modal-content">
									<br>
									<div id="hide">
									<h4 class="TitleCalZakat">Je calcule ma zakat</h4>
									<hr />


									<center>
										<div class="FormZakatTitleCont">
											<div class="FormZakatTitleContRichesse">Richesse</div>
											<div class="FormZakatTitleContD" hidden><img src="img/Down.png" width="15"
													height="25" />
											</div>
										</div>
										<br>

										<div class="FormZakatCont">
											<div class="FormZakatContG" style="right: 360px;">Espèces à la maison</div>
											<div class="FormZakatContD"><input class="InputBas" id="amount_home"
													step="any" type="number" onchange="calculate()" />
											</div>
											<div class="Euro">€
											</div>
										</div>
										...
										<div class="FormZakatCont">
											<div class="FormZakatContG" style="right: 330px;"><label
													for="amount_bank">Solde du compte bancaire</label></div>
											<div class="FormZakatContD"><input class="InputBas" id="amount_bank"
													step="any" type="number" onchange="calculate()" />
											</div>
											<div class="Euro">€
											</div>
										...
										<div class="FormZakatCont">
											<div class="FormZakatContG"><label for="amount_shares">Valeur de rachat des
													actions</label></div>
											<div class="FormZakatContD"><input class="InputBas" id="amount_shares"
													step="any" type="number" s onchange="calculate()" />
											</div>
											<div class="Euro">€
											</div>
										</div>
										...
										<div class="FormZakatCont">
											<div class="FormZakatContG" style="right: 347px;"><label
													for="amount_merchandise">Bénéfices &amp; inventaire</label></div>
											<div class="FormZakatContD"> <input class="InputBas" id="amount_merchandise"
													step="any" type="number" onchange="calculate()" />
											</div>
											<div class="Euro">€
											</div>
										...
										<div class="FormZakatCont">
											<div class="FormZakatContG" style="right: 395px;"><label
													for="amount_gold">Or &amp; Argent</label></div>
											<div class="FormZakatContD"><input class="InputBas" id="amount_gold"
													step="any" type="number" onchange="calculate()" />
											</div>
											<div class="Euro">€
											</div>
										...
										<div class="FormZakatCont">
											<div class="FormZakatContG" style="right: 328px;"><label for="">Propriété
													d'investissement</label></div>
											<div class="FormZakatContD"><input class="InputBas" id="amount_property"
													step="any" type="number" onchange="calculate()">
											</div>
											<div class="Euro">€
											</div>
										...
										<div class="FormZakatCont">
											<div class="FormZakatContG" style="right: 368px;"><label for="">Tout autre
													revenu</label></div>
											<div class="FormZakatContD"><input class="InputBas" id="amount_other"
													step="any" type="number" onchange="calculate()">
											</div>
											<div class="Euro">€
											</div>
										...
										<br>
										<div class="FormZakatTitleCont">
											<div class="FormZakatTitleContRichesse">Déductions</div>
											<div class="FormZakatTitleContD" hidden><img src="img/Down.png" width="15"
													height="25" />
											</div>
										...
										<div class="FormZakatCont">
											<div class="FormZakatContG" style="right:368px;"><label
													for="">Dettes</label></div>
											<div class="FormZakatContD"><input class="InputBas" id="amount_debts"
													step="any" type="number" onchange="calculate()">
											</div>
											<div class="Euro">€
											</div>
										...
										<div class="FormZakatCont">
											<div class="FormZakatContG" style="right:368px;"><label
													for="">Dépenses</label></div>
											<div class="FormZakatContD"><input class="InputBas" id="amount_expenses"
													step="any" type="number" onchange="calculate()">
											</div>
											<div class="Euro">€
											</div>
										...
										<div class="FormZakatTitleCont">
											...
											<div class="FormZakatTitleContD"><input class="InputBas" id="amount_zakat"
													type="text" readonly="readonly">
											</div>
										</div>
										<input id="amount_eligable" hidden type="text" style="width: 300px; right:100px"
											readonly="readonly" onchange="calculate()">
...
<div id="show" style="display: none;">
	<center>
		...
		<div class="FormZakatTitleCont">
			<div class="FormZakatTitleContRichesse">Le Total</div>
			<div class="FormZakatTitleContD"><input class="InputBas" id="Szakat"
					type="text">
			</div>
			<div class="Eurod">€
			</div>
	...
	<br>
	<br>
	<center><a class="button button--primary" id="donate_button2"
			style="background-color: #0c253c;border-color: #045dab;width: 50%; color: #ffff; "
			data-amount="50" data-formId="2426" href="#">Je paie ma zakat</a>
	</center>
									...
									<br>
										...
										<div>
										<input type="button" class="button button--primary" id="donate_button9"
											
											style="border-color: #4A4C70; color: rgb(0, 0, 0); "
											data-amount="50" data-formId="2426" href="#" value="je verse ma zakat" />
										</div>
			...
			<!-- citation start-->
			<section class="subscribe" style="background-color: #fff;">
				<hr>
				<div class="container">
					<div class="row">
						<div class="col-xl-12 text-center mb-2"><i class="fas fa-quote-left fa-3x"style="color: #045dab;"></i></div>
			...
			<section class="section action-section">
				<div class="jarallax">
					<picture>
						<source srcset="img/Quote1.jpg" media="(min-width: 992px)" /><img class="jarallax-img" src="img/Quote1.jpg"
							alt="img" />
					</picture>
				</div>
				<div class="container">
			...
			<!--contacts start-->
			<section class="section contacts" style=" font-family: 'Montserrat';" id="Contact1">
				<div class="container">
					...
					<div class="row offset-margin">
						<div class="col-sm-6 col-lg-3">
							<div class="icon-item">
								<div class="icon-item__img">
									...
									<svg class="icon icon-item__icon icon--4">
						...
						<div class="col-sm-6 col-lg-3">
							<div class="icon-item">
								<div class="icon-item__img">
									...
									<svg class="icon icon-item__icon icon--3">
						...
						<div class="col-sm-6 col-lg-3">
							<div class="icon-item">
								<div class="icon-item__img">
									<!-- <img class="img--layout" src="img/counter_2.png" style="opacity: 0.3;" alt="img"/> -->
									<svg class="icon icon-item__icon icon--2">
										<use xlink:href="#envelope"></use>
									</svg>
								</div>
								<div class="icon-item__text">
									<p style="color: black;">Email: <a class="icon-item__link"
											href="mailto:Bureau@centre-des-lumieres.fr" style="color: black;">Bureau@centre-des-lumieres.fr</a>
									</p>
								</div>
							</div>
						</div>
						<div class="col-sm-6 col-lg-3">
							<div class="icon-item">
								<div class="icon-item__img">
									<!-- <img class="img--layout" src="img/counter_2.png" style="opacity: 0.3;" alt="img"/> -->
									<svg class="icon icon-item__icon icon--1">
								...
								<div class="row justify-content-end">
									...
									<form class="form message-form" action="javascript:void(0);">
										...
										<div class="row">
											...
											<div class="col-lg-6">
												<input class="form__field" type="text" name="last-name"
											...
											<div class="col-12">
												<button class="form__submit" type="submit" style="color: black;">Envoyer</button>
											</div>
										</div>
									</form>
		...
		<footer class="footer footer--front_2">
			<div class="container">
				<div class="row">
					<div class="col-sm-6 col-lg-4">
						<div class="footer-logo"><a class="footer-logo__link" href="index.html"><img
									class="footer-logo__img" src="img/logo_white.png" alt="logo" /></a></div>
						<div class="footer-contacts">
							<p class="footer-contacts__address">Rue Galilée Zac de la Vilette aux aulnes 77290
								mitry-mory</p>
							<p class="footer-contacts__phone">Phone: <a href="tel:06 72 23 00 00">06 72 23 00 00</a></p>
					...
					<div class="col-lg-4 col-xl-3 offset-xl-1">
						<h6 class="footer__title">menus et liens</h6>
						<div class="footer__form">
							<nav>
								<ul class="footer-menu">
									...
									<li class="footer-menu__item"><a class="footer-menu__link" href="#">HUMANITAIRE</a>
									</li>
									<li class="footer-menu__item"><a class="footer-menu__link" href="#QuiSommeNous">A
											Propos </a></li>
									<li class="footer-menu__item"><a class="footer-menu__link" href="#">C.L.E.S</a></li>
									<li class="footer-menu__item"><a class="footer-menu__link"
											href="index.html">Zakat</a></li>
									<li class="footer-menu__item"><a class="footer-menu__link" href="#">CULTUEL</a></li>
									<li class="footer-menu__item"><a class="footer-menu__link" href="#Contact1">
											Contact</a></li>
				...
				<div class="row align-items-baseline">
					<div class="col-md-6">
						<p class="footer-copyright">Copyright © 2021 Centre des lumieres | Powered by MiraiΦ Solutions
						</p>
					</div>
					<div class="col-md-6">
	...
	<script>
		...
		function calculate() {
			...
			console.log(amt_zakat);
			document.getElementById("Szakat").value = formatter.format(amt_zakat);
			return (amt_zakat);
		}
