					...
					<ul class="aside-menu">
						...
						<li class="aside-menu__item aside-menu__item--has-child aside-menu__item--active"><a class="aside-menu__link" href="javascript:void(0);"><span>Elements</span></a>
							...
							<ul class="aside-menu__sub-list">
								...
								<li class="item--active"><a href="pricing-plan.html"><span>Pricing Plan</span></a></li>
			...
			<main class="main">
				<section class="promo-primary promo-primary--elements">
					<picture>
						...
						<video class="img--bg"  loop autoplay muted >
							<source src="img/ANIMATION_1.mp4.mp4" type="video/mp4">
							...
							<div class="col-auto">
								<div class="align-container">
									<div class="align-container__item"><span class="promo-primary__pre-title">Helpo</span>
										<h1 class="promo-primary__title"><span>Pricing Plan</span></h1>
									</div>
								</div>
							</div>
						</div>
				...
				<section class="section elements no-padding-top">
					...
					<section class="section pricing pricing--style-4">
						<div class="pricing--style-4__bg jarallax">
							<picture>
				...
				<section class="section elements no-padding-top">
					<div class="container">
						<div class="row">
							<div class="col-auto">
								<h4 class="elements__title">Variant 4</h4>
							</div>
						</div>
					</div>
					<!-- pricing style-3 start-->
					<section class="section pricing pricing-style--3 no-padding-top no-padding-bottom">
						<div class="container">
							<div class="row">
								<div class="col-lg-12">
									<div class="pricing-item pricing-item--style-3">
										<div class="row align-items-center">
											<div class="col-lg-2">
												<h6 class="pricing-item__plan">Basic </h6>
											</div>
											<div class="col-lg-5"><span>Sharksucker sea toad candiru rocket danio tilefish stingray</span></div>
											<div class="col-lg-2 text-center">
												<div class="pricing-item__price">Free</div>
											</div>
											<div class="col-lg-3 text-lg-right"><a class="pricing-item__button button button--primary" href="#">Get Started</a></div>
										</div>
									</div>
								</div>
								<div class="col-lg-12">
								...
								<div class="col-lg-12">
									<div class="pricing-item pricing-item--style-3 pricing-item--selected">
										<div class="row align-items-center">
											<div class="col-lg-2">
												<h6 class="pricing-item__plan">Optimal </h6>
											</div>
