...
<div class="d-flex" id="wrapper">
  ...
  <tr>
  <?php
           if($fetch_benevole->num_rows() > 0)
           {
                foreach($fetch_benevole->result() as $row)
                {
           ?>
                <tr>
                     ...
                     <td><?php echo date( "d/m/y h:i:sa", strtotime($row->datejour)) ; ?></td>
...
<script>
  ...
  table2excel.export(document.querySelectorAll("#table"), "Tableau benevole");
    });
