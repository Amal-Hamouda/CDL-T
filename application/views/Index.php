	...
	<div class="page-wrapper">
		...
		<div class="aside-dropdown">
			<div class="aside-dropdown__inner"><span class="aside-dropdown__close">
				...
				<div class="aside-dropdown__item">
					...
					<!-- aside menu end-->
					<div class="aside-inner"><span class="aside-inner__title">Email</span><a class="aside-inner__link" href="mailto:support@helpo.org">culturel@centre-des-lumieres.fr</a></div>
					...
					<ul class="aside-socials">
						<li class="aside-socials__item"><a class="aside-socials__link" href="https://www.facebook.com/Centredeslumieres/"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
						...
						<li class="aside-socials__item"><a class="aside-socials__link" href="https://www.instagram.com/centredeslumieres/"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
						<li class="aside-socials__item"><a class="aside-socials__link" href="https://www.youtube.com/channel/UCEQ3IEfGzlegMOjnBLE2rJw"><i class="fa fa-youtube-play" aria-hidden="true"></i></a></li>
					</ul>
				</div>
		...
		<div class="top-bar d-none d-lg-block" style="background:#d4ac46">
			<div class="container-fluid">
				<div class="row align-items-end">
					<div class="col-lg-9"><a class="top-bar__link" href="tel:06 72 23 00 00" style="color:black">06 72 23 00 00</a><a class="top-bar__link" href="mailto:culturel@centre-des-lumieres.fr" style="color:black">Bureau@centre-des-lumieres.fr</a></div>
					<div class="col-lg-3 text-right">
						<ul class="socials">
							<li class="socials__item"><a class="socials__link" href="https://www.facebook.com/Centredeslumieres/"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
							<li class="socials__item"><a class="socials__link" href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
							<li class="socials__item"><a class="socials__link" href="https://www.instagram.com/centredeslumieres/"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
							<li class="socials__item"><a class="socials__link" href="https://www.youtube.com/channel/UCEQ3IEfGzlegMOjnBLE2rJw"><i class="fa fa-youtube-play" aria-hidden="true"></i></a></li>
		...
		<section>
			<section>
				...
				<div class="d-flex justify-content-center align-items-center flex-column d-sm-none d-md-block d-lg-none">
					<a href="#">
			...
			<section class="section action-section">
				<div class="jarallax">
					<picture>
						<source srcset="<?php echo base_url(); ?>/resources/img/imageporte.png" media="(min-width: 992px)" /><img class="jarallax-img" src="<?php echo base_url(); ?>/resources/img/imageporte.png" alt="img" />
					</picture>
				</div>
				<div class="container">
					<div class="d-flex justify-content-center">
						<div class="col-12 col-md-12" style="background-color: #d4ac46;border-radius: 8px;opacity:0.9; color:black;">
							<p style=" font-size: 16px; font-weight: 600;"> <br> Depuis maintenant plusieurs années le centre des lumières fait la promotion de la culture
								arabo-musulmane en France et dans le monde à travers :<br>
								la littérature, les sciences et techniques islamiques, la civilisation, la calligraphie, l'art
								(peinture sculpture, musique, poésie, architecture, archéologie).
								<br>
								Il utilise tous les moyens et supports disponible pour y arriver, diffusion matérialisée et
								dématérialisé via la vidéo audio radio l'édition et la publication web des conférences des
								séminaires et galas, colloques, cours et formation expositions festivités spectacles, il est un
								partenaire privilégié des institutions pour réaliser ses objectifs d'accompagnement et de
								promotion de la culture arabo-musulmane dans les communes, les centres pénitentiaires,
								Hôpitaux centre de jeunesse, Lycées collèges écoles et autres institutions, à travers ses 3
								pôles Cultuel Culturel et humanitaire.
							</p>
						</div>
					</div>
				</div>
					...
					<div class="row align-items-center">
						...
						<div class="col-lg-6 col-xl-6 offset-xl-1">
							...
							<p>Il ambitionne de s’ériger comme pont de dialogue avec notre société de droit commun au
								...
								fraternité, d’égalité et de liberté, trouve ainsi un sens à l’institut des Lumières. </p>
							<p></p>
			...
			<section class="section about-us" id="vision">
				...
				<div class="container">
					<div class="row align-items-center">
						...
						<div class="col-lg-6 col-xl-5 offset-xl-1">
							<div class="img-box">
								<div class="img-box__img"><img class="img--bg" style="height: 90%;" src="<?php echo base_url(); ?>/resources/img/vision.jpg" alt="img" /></div>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="col-lg-4 col-md-12">
							<div class="event-item">
								<div class="event-item__content">
									...
									<br>
									<center><a href="#modalScrollableCenter" style="color: black;" role="button" class="button button--primary" data-toggle="modal">Plus de détail</a>
									</center>
								</div>
							</div>
						</div>
			...
			<section class="section action-section" style="padding:120px 0">
				<div class="jarallax">
					<picture>
						<source srcset="<?php echo base_url(); ?>/resources/img/hand.png" media="(min-width: 992px)" /><img class="jarallax-img" src="<?php echo base_url(); ?>/resources/img/hand.png" alt="img" />
					</picture>
				</div>
				<div class="container">
					<div class="row">
						<div class="col-lg-6 col-xl-4">
							...
							<p style=" font-size: 32px; font-weight: bold; line-height: normal;">“ Quiconque prête à Dieu de bonne grâce, Il le lui rendra multiplié
								plusieurs fois.. ”</p> <br>
							<div id="Quoteita" style="color:#777">Coran sourate 1,verset 245</div>
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-md-6 col-lg-4">
							...
							<div class="accordion accordion--bordered">
								<div class="accordion__title-block">
									<h6 class="accordion__title">La lutte contre la discrimination</h6><span class="accordion__close"></span>
								</div>
								<div class="accordion__text-block">
									<p>S’engager à lutter contre toute forme de discrimination, que ce soit explicite
										ou
										implicite.
										Accepter les personnes d’origine, d’horizon, de conviction et de confession
										différentes est de rigueur et souscrit au bon vivre et faire ensemble.
									</p>
								</div>
							</div>
							<div class="accordion accordion--bordered">
								<div class="accordion__title-block">
									<h6 class="accordion__title">Les Valeurs relationnelles</h6><span class="accordion__close"></span>
								</div>
								<div class="accordion__text-block">
							...
							<div class="accordion accordion--bordered" id="accP">
								<div class="accordion__title-block">
									<h6 class="accordion__title">L’Homme et la Femme en Islam </h6><span class="accordion__close"></span>
								</div>
								<div class="accordion__text-block">
									<p>Nous honorons aussi bien l’homme que la femme. Nous condamnons toute idée ou
										...
										justifications coutumières ou ancestrales.</p>
								</div>
							</div>
							<div class="accordion accordion--bordered" id="accP">
								<div class="accordion__title-block">
								...
								<div class="accordion__text-block">
									<p>S'opposer à toutes les ingérences des États étrangers dans la gestion du culte en
										France
						...
						<div class="col-md-6 col-lg-4">
							...
							<div class="accordion accordion--bordered">
								<div class="accordion__title-block">
									<h6 class="accordion__title">L’environnement</h6><span class="accordion__close"></span>
								</div>
								<div class="accordion__text-block">
							...
							<div class="accordion accordion--bordered">
								<div class="accordion__title-block">
									<h6 class="accordion__title">Le Conflit d’intérêts</h6><span class="accordion__close"></span>
								</div>
								<div class="accordion__text-block">
							...
							<div class="accordion accordion--bordered" id="accP">
								<div class="accordion__title-block">
									<h6 class="accordion__title">La lutte contre la radicalisation</h6><span class="accordion__close"></span>
								</div>
								<div class="accordion__text-block">
									<p>Lutter contre toute forme de radicalisation. Rejeter toute forme d’extrémisme
										ou d’excès dans notre pratique ou dans l’attitude afin de garantir la paix et le vivre-ensemble
										et surtout de le faire ensemble.</p>
								</div>
							</div>
				...
				<div class="row offset-margin">
					<div class="col-md-4 text-center">
						<div class="counter-item counter-item--style-3">
							...
							<div class="counter-item counter-item--style-3">
								...
								<div class="counter-item__lower" style=" color : #d4ac46;"><span class="js-counter">3,689
									</span></div>
							</div>
					...
					<div class="col-md-4 text-center">
						<div class="counter-item counter-item--style-3">
							...
							<div class="counter-item counter-item--style-3">
								<div class="counter-item__top">
									<h6 class="counter-item__title" style=" color : black;">Projets</h6>
								</div>
								<div class="counter-item__lower" style=" color : #d4ac46;"><span class="js-counter">25</span></div>
							</div>
					...
					<div class="col-md-4 text-center">
						<div class="counter-item counter-item--style-3">
							<div class="counter-item__top">
								<h6 class="counter-item__title" style=" color : black;">Repas livrés</h6>
							</div>
				...
				<div class="container" id="Participer" style="margin-top:40px;margin-bottom: -40px ;">
					<div class="row">
						...
						<div class="col-12 text-center">
							<h2 class="action-section__title" style=" font-family: 'Montserrat';font-weight: 90; color:black">Adhérez<br>
								À notre cause</h2>
						</div>
							...
							<div class="testimonials-slider testimonials-slider--style-1">
								<div class="testimonials-slider__item">
									...
									<div class="testimonials-slider__text">
										...
										<div class="testimonials-slider__author"><span class="testimonials-slider__name">John Dubois, </span><span class="testimonials-slider__position">Volunteer</span></div>
									</div>
								</div>
								<div class="testimonials-slider__item">
									<div class="testimonials-slider__icon" style="color:#d4ac46">“</div>
									<div class="testimonials-slider__text">
										<p>Slickhead grunion lake trout. Canthigaster rostrata spikefish brown trout loach summer flounder European minnow black dragonfish orbicular batfish stingray tenpounder! Flying characin herring, Moses sole sea snail grouper discus. European eel slender snipe eel. Gulper eel dealfish ocean sunfish; rohu yellow-and-black triplefin Atlantic saury</p>
										<p>Slickhead grunion lake trout. Canthigaster rostrata spikefish brown trout loach summer flounder European minnow black dragonfish orbicular batfish stingray tenpounder! Flying characin herring, Moses sole sea snail grouper discus. European eel slender snipe eel. Gulper eel dealfish ocean sunfish; rohu yellow-and-black triplefin Atlantic saury</p>
										<div class="testimonials-slider__author"><span class="testimonials-slider__name">Claire Quere, </span><span class="testimonials-slider__position">Volunteer</span></div>
									</div>
								</div>
								<div class="testimonials-slider__item">
									<div class="testimonials-slider__icon" style="color:#d4ac46">“</div>
									<div class="testimonials-slider__text">
										<p>Slickhead grunion lake trout. Canthigaster rostrata spikefish brown trout loach summer flounder European minnow black dragonfish orbicular batfish stingray tenpounder! Flying characin herring, Moses sole sea snail grouper discus. European eel slender snipe eel. Gulper eel dealfish ocean sunfish; rohu yellow-and-black triplefin Atlantic saury</p>
										<div class="testimonials-slider__author"><span class="testimonials-slider__name">Erwan Renault, </span><span class="testimonials-slider__position">Volunteer</span></div>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row offset-margin">
							...
							<div class="col-sm-3 col-lg-3">
								<div class="icon-item">
									...
									<div class="icon-item__text">
										<p>Email: <a class="icon-item__link" href="mailto:culturel@centre-des-lumieres.fr">culturel@centre<br>-des-lumieres.fr</a>
										</p>
									</div>
								</div>
							</div>
								...
								<div class="container">
									<div class="row justify-content-end">
										...
										<form class="form message-form" action="<?php echo base_url() ?>index.php/Home/form_validation" method="post" onsubmit="alert('message envoyé !')">
											...
											<div class="row">
												<div class="col-lg-6">
													<input class="form__field" type="text" name="first-name" placeholder="Prenom *" required="required" />
												</div>
												<div class="col-lg-6">
													<input class="form__field" type="text" name="last-name" placeholder="Nom *" required="required" />
												</div>
												<div class="col-lg-6">
			...
			<footer class="footer footer--front_2">
				<div class="container">
					<div class="row">
						<div class="col-sm-6 col-lg-4">
							...
							<div class="footer-contacts">
								...
								<p class="footer-contacts__mail">Email: <a href="mailto:culturel@centre-des-lumieres.fr">culturel@centre-des-lumieres.fr</a></p>
							</div>
							<!-- footer socials start-->
							<ul class="footer-socials">
								<li class="footer-socials__item"><a class="footer-socials__link" href="https://www.facebook.com/Centredeslumieres/"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
								<li class="footer-socials__item"><a class="footer-socials__link" href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
								<li class="footer-socials__item"><a class="footer-socials__link" href="https://www.instagram.com/centredeslumieres/"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
								<li class="footer-socials__item"><a class="footer-socials__link" href="https://www.youtube.com/channel/UCEQ3IEfGzlegMOjnBLE2rJw"><i class="fa fa-youtube-play" aria-hidden="true"></i></a></li>
							...
							<div class="footer__form">
								<nav>
									<ul class="footer-menu">
										...
										<li class="footer-menu__item"><a class="footer-menu__link fix" href="#QuiSommeNous">A
												Propos </a></li>
										<li class="footer-menu__item"><a class="footer-menu__link" href="<?php echo site_url("Cultuel"); ?>">Cultuel</a>
										</li>
										<li class="footer-menu__item"><a class="footer-menu__link fix" href="#vision">Vision</a></li>
					...
					<div class="row align-items-baseline">
						<div class="col-md-12">
							<p class="footer-copyright" style="text-align: center;">Copyright © 2022 Centre des lumieres | Powered by MiraiΦ
								Solutions
							</p>
						</div>
