				...
				<div class="row justify-content-center">
					<div class="col-11 col-sm-9 col-md-7 col-lg-6 col-xl-5 text-center p-0 mt-3 mb-2"style ="border-radius:10px;box-shadow:5px 5px 5px 5px whitesmoke;m">
						<div class="card px-0 pt-4 pb-0 mt-3 mb-3" style="margin:20px">
							...
							<ul id="progressbar" style="margin-left:12%">
								...
								<fieldset>
									<div class="form-card">
										<div class="row">
											<div class="col-12">
												<h2 class="fs-title" >Soutenez notre cause</h2>
											</div>
													...
													<div class="container pb-5">
														<div class="row justify-content-center pb-5">
															...
															<div class="row">
																...
																<div class="col-4">
																<input class="checkbox-budget" type="radio" name="data" id="budget-1" onclick="enableBut()" value="10" checked>
																<label class="for-checkbox-budget" for="budget-1">
																	<span data-hover="10€">10€</span>
																</label><!--
																	
																-->
																<input class="checkbox-budget" type="radio" name="data" id="budget-2" onclick="enableBut()" value="25">
																<label class="for-checkbox-budget" for="budget-2">							
																	<span data-hover="25€">25€</span>
																</label></div><!--
																--><div class="col-4"><input class="checkbox-budget" type="radio" name="data" id="budget-3" onclick="enableBut()" value="50">
																<label class="for-checkbox-budget" for="budget-3">							
																	<span data-hover="50€">50€</span>
																</label><!--

																--><input class="checkbox-budget" type="radio" name="data" id="budget-4" onclick="enableBut()" value="100">
																<label class="for-checkbox-budget" for="budget-4">							
																	<span data-hover="100€">100€</span>
																</label></div><!--
																--><div class="col-4"><input class="checkbox-budget" type="radio" name="data" id="budget-5" onclick="enableBut()" value="250">
 ...
 <script src="https://www.paypal.com/sdk/js?client-id=AcAUrZDfwcXyX3G0de-lbhxpiT6fqTgTBDyI31Zd9P4WdkbUX7AaoBXEbvNewQp5EpzaAvP0ZjEmUTCW&disable-funding=credit,card"></script>
   ...
   <!-- End -->
																...
																<div id="net-banking" class="tab-pane fade pt-3">
																	...
																	<p>	<a href="https://pay-sandbox.gocardless.com/AL00005SRXKQSB" action="Redirectflow.php" class="btn btn-primary"><i class="fas fa-mobile-alt mr-2"></i> Proceed Payment</a></p>
																	</div>
...
document.getElementById("budget-6").value= personel;
									...
									$('#myLink').wrap('<form id ="form2" action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post" target="_top"><div id="divform"><input type="hidden" name="cmd" value="_xclick-subscriptions"><input type="hidden" name="business" value="Tutorial@business.example.com"><input type="hidden" name="lc" value="FR"><input type="hidden" name="item_name" value="test"><input type="hidden" name="item_number" value="002"><input type="hidden" name="no_note" value="1"><input type="hidden" name="src" value="1"><input type="hidden" name="currency_code" value="USD"><input type="hidden" name="bn" value="PP-SubscriptionsBF:btn_subscribeCC_LG.gif:NonHostedGuest"><table style="margin-left: auto;margin-right: auto;"><tr><td><input type="hidden" name="on0" value="Payments"><div style="text-align:center">Montant</div></td></tr><tr><td><select class="form-select" name="os0"><option value="Option 1">Option 1 : '+AmountPay+' USD - monthly</option></select> </td></tr></table><input type="hidden" name="option_select0" value="Option 1"><input type="hidden" name="option_amount0" value="'+AmountPay+'"><input type="hidden" name="option_period0" value="M"><input type="hidden" name="option_frequency0" value="1"><input type="hidden" name="option_select1" value="Option 2"><input type="hidden" name="option_amount1" value="20.00"><input type="hidden" name="option_period1" value="M"><input type="hidden" name="option_frequency1" value="1"><input type="hidden" name="option_select2" value="Option 3"><input type="hidden" name="option_amount2" value="100.00"><input type="hidden" name="option_period2" value="M"><input type="hidden" name="option_frequency2" value="1"><input type="hidden" name="option_index" value="0"><input type="image" src="https://www.sandbox.paypal.com/en_US/FR/i/btn/btn_subscribeCC_LG.gif" id ="paypalimg" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!"><img alt="" border="0" src="https://www.sandbox.paypal.com/en_US/i/scr/pixel.gif" width="1" height="1"></div></form>');
...
myButton.close();
console.log('hey');
document.getElementById('divform').outerHTML= "";
}
  }
</script>
