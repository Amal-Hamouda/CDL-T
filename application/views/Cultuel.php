...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url();?>/resources/css/don.css" />
...
<body style=" font-family: 'Montserrat';">
    <div class="page-wrapper">
        ...
        <!-- aside dropdown end-->
        <!-- top bar start-->
        <div class="top-bar d-none d-lg-block" style="background:#002a77">
        ...
        <div class="container" id="horairep"style="padding-top:50px; padding-bottom:50px">
            <div class="row">
                <div class="col-xl-12 text-center m-3">
                    <!-- masjid start  -->
                    <h2 class="heading__title"><span style="color: #045dab;letter-spacing: 0.1px;">HORAIRE DES PRIÉRES</span> </h2>
                    <script type="text/javascript">
                        (function(w) {
                            ...
                            if (w.attachEvent) w.attachEvent('onload', async_load);
                            else w.addEventListener('load', async_load, false);
                        })(window);
                    </script><a data-masjidbox-widget="loCMkjIK3vdYvEC7pjLMo" data-masjidbox-ifr href="https://masjidbox.com/horaires-de-priere/a-1624715666239">Horaires de prière a</a>
                    <!-- masjid end  -->
                </div>
            </div>
        </div>
                    ...
                    <div class="modal fade bd-example-modal-lg" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div id="hide">
                                    ...
                                    <center>
                                        <div class="FormZakatTitleCont">
                                            ...
                                            <div class="FormZakatTitleContD" hidden><img src="<?php echo base_url();?>/resources/img/Down.png" width="15" height="25" />
                                            </div>
                                        </div>
                                        <br>
                                        ...
                                        <div class="FormZakatCont">
                                            ...
                                            <div class="FormZakatContGEspece">Espèces à la maison</div>

                                            <div class="FormZakatContD"><input class="InputBas" id="amount_home" step="any" type="number" onchange="calculate()" />
                                            </div>
                                            <div class="Euro">€
                                            </div>
                                        </div>
                                        ...
                                        <div class="FormZakatCont">
                                            <div class="FormZakatContGSoldeC"><label for="amount_bank">Solde du compte bancaire</label></div>
                                            <div class="FormZakatContD"><input class="InputBas" id="amount_bank" step="any" type="number" onchange="calculate()" />
                                            </div>
                                            <div class="Euro">€
                                            </div>
                                        </div>
                                        ...
                                        <div class="FormZakatCont">
                                            <div class="FormZakatContGVal"><label for="amount_shares">Valeur de rachat des
													actions</label></div>
                                            <div class="FormZakatContD"><input class="InputBas" id="amount_shares" step="any" type="number" s onchange="calculate()" />
                                            </div>
                                            <div class="Euro">€
                                            </div>
                                        </div>
                                        ...
                                        <div class="FormZakatCont">
                                            <div class="FormZakatContGBenefice"><label for="amount_merchandise">Bénéfices &amp; inventaire</label></div>
                                            <div class="FormZakatContD"> <input class="InputBas" id="amount_merchandise" step="any" type="number" onchange="calculate()" />
                                            </div>
                                            <div class="Euro">€
                                            </div>
                                        </div>
                                        ...
                                        <div class="FormZakatCont">
                                            <div class="FormZakatContGOr"><label for="amount_gold">Or &amp; Argent</label></div>
                                            <div class="FormZakatContD"><input class="InputBas" id="amount_gold" step="any" type="number" onchange="calculate()" />
                                            </div>
                                            <div class="Euro">€
                                            </div>
                                        </div>
                                        ...
                                        <div class="FormZakatCont">
                                            <div class="FormZakatContGProp"><label for="">Propriété
													d'investissement</label></div>
                                            <div class="FormZakatContD"><input class="InputBas" id="amount_property" step="any" type="number" onchange="calculate()">
                                            </div>
                                            <div class="Euro">€
                                            </div>
                                        </div>
                                        ...
                                        <div class="FormZakatCont">
                                            <div class="FormZakatContGAutre"><label for="">Tout autre
													revenu</label></div>
                                            <div class="FormZakatContD"><input class="InputBas" id="amount_other" step="any" type="number" onchange="calculate()">
                                            </div>
                                            <div class="Euro">€
                                            </div>
                                        </div>
                                        <br>
                                        <div class="FormZakatTitleCont">
                                            <div class="FormZakatTitleContDeduction">Déductions</div>
                                            <div class="FormZakatTitleContD" hidden><img src="<?php echo base_url();?>/resources/img/Down.png" width="15" height="25" />
                                            </div>
                                        ...
                                        <div class="FormZakatCont">
                                            ...
                                            <div class="FormZakatContGDette"><label for="">Dettes</label></div>
                                            <div class="FormZakatContD"><input class="InputBas" id="amount_debts" step="any" type="number" onchange="calculate()">
                                            </div>
                                            <div class="Euro">€
                                            </div>
                                        </div>
                                        ...
                                        <div class="FormZakatCont">
                                            <div class="FormZakatContGDepense"><label for="">Dépenses</label></div>
                                            <div class="FormZakatContD"><input class="InputBas" id="amount_expenses" step="any" type="number" onchange="calculate()">
                                            </div>
                                            <div class="Euro">€
                                            </div>
                                        </div>
                                        ...
                                        <div class="FormZakatTitleCont">
                                            ...
                                            <div class="FormZakatContDT"><input class="InputBas" id="amount_zakat" type="text" readonly="readonly">
                                            </div>
                                            <div class="EuroT">€
                                            </div>
                                        </div>
                                        <input id="amount_eligable" hidden type="text" style="width: 300px; right:100px" readonly="readonly" onchange="calculate()">
                                ...
                                <div>
                                    <input type="button" class="button button--primary" id="donate_button9" style="border-color: #4A4C70; color: rgb(0, 0, 0);" data-amount="50" data-formId="2426" href="#" value="je verse ma zakat" />
                                </div>

                                <br>
                                <div id="AlertVide" class="alert alert-danger" style="visibility: hidden; width: 50%; margin-top:auto; margin-bottom:auto; margin-left: auto;
										  margin-right: auto;" role="alert">
                                    Veuillez remplir un champ
                                </div>
                            ...
                            <div class="row align-items-center" id="AppT">
                                ...
                                <div class="col-lg-5 col-sm-6">
                                    ...
                                    <div class="heading heading--primary heading--centerContact">
                                        <h2><span style="color:#045dab;">Télécharger</span> <span style="color:black">l'application</span></h2>
        ...
        <section style="background-image: url(<?php echo base_url();?>/resources/img/imampic2.png);background-repeat: no-repeat;background-size: cover; background-attachment: fixed; background-position:center center; padding-top: 1%;"id="QuestionImam">
            <div>
                <div class="row justify-content-end">
                    ...
                    <form class="form message-form_ben" action="<?php echo base_url()?>index.php/Cultuel/form_question" method="post" onsubmit="alert('message envoyé !')">
                ...
                <section class="section contacts no-padding-top" style=" font-family: 'Montserrat';">
                    <div class="contacts-wrapper">
                        <div class="container">
                            <div class="row justify-content-end">
                                <br>
                                <form class="form message-form" action="<?php echo base_url()?>index.php/Cultuel/form_contact" method="post" onsubmit="alert('message envoyé !')">
...
<!-- footer end-->
    ...
    <script>
        ...
        $("#donate_button9").click(function() {
            ...
            var home = document.getElementById("amount_home").value;
            var bank = document.getElementById("amount_bank").value;
            var shares = document.getElementById("amount_shares").value;
            var merchandise = document.getElementById("amount_merchandise").value;
            var gold = document.getElementById("amount_gold").value;
            var property = document.getElementById("amount_property").value;
            var other = document.getElementById("amount_other").value;
            var debts = document.getElementById("amount_debts").value;
