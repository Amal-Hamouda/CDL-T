...
<body>
    ...
    <div class="page-wrapper">
        ...
        <main class="main">
            ...
            <section class="section" id="aprop">
                <div class="container">
                        ...
                        <div class="col-lg-6 col-xl-5">
                            <div class="heading heading--primary">
                                <h2 class="heading__title primary-color" id="titleAL"><span style="color: black;font-weight:lighter;font-size: xx-large;">À PROPOS DE</span>
                                    <br />
                                    <span style="font-weight:lighter;">AU DELÀ DES MOTS </span>
                                </h2>
                            </div>
                    ...
                    <div style="margin-bottom:30px">
                        <p style="display:none;" id="para">Les mécanismes établis par la religion (p. ex. la zakat, le waqf et la kaffara) ont eu un impact sans précédent sur la vie de la population : affranchissement des esclaves, soutien significatif aux plus vulnérables et expansion du système d’éducation et de santé. Aujourd’hui, "Y&S for humanity", fondée sur la foi, se réfère à ces textes pour lancer ses programmes humanitaires dans divers domaines. L’humanitaire est un des principes fondamentaux de la religion musulmane.<br>
                            Faire un don ou secourir un sinistré sont des actes qui ne sont pas laissés à la libre appréciation du croyant. Mais, ils sont parfois obligatoires au même titre que la prière, le jeûne du Ramadan ou le pèlerinage à La Mecque. L’exercice de l’acte humanitaire chez le musulman est donc une composante essentielle de la pratique religieuse, qu’il se limite à un don en argent ou en nature ou qu’il revête une forme plus pratique telle que, par exemple, don de soi, secours ou distribution d’aide.<br>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xl-12 text-center m-2">
                            ...
                            <h2 class="Quote_1" style="letter-spacing: 0.6px;font-weight:500 ;text-align:center">Le Messager d’Allah (صلى الله عليه وسلم (a dit: « Faites de bonnes œuvres avec sérieux, sincérité et modération
                                ! Et sachez que vos actes ne vous feront pas entrer au Paradis, et que l’acte le plus aimé auprès
                                d’Allah est le plus constant, cela même s’il est petit ».
                            </h2>
                        </div>
                        <br>
                        <div class="col-xl-12 text-center mb-3" style="color: whitesmoke;font-weight:100">[Sahih al-Bukhari 6464]</div>
                    </div>

                </div>
            </section>
            <section class="section action-section" style="padding:120px 0px;background-image:url(<?php echo base_url(); ?>/resources/img/sectiondon.png);background-repeat: no-repeat;" id="fairedonimg">
            ...
            <section class="section action-section">
                <div class="jarallax">
                    <picture>
                        <source srcset="<?php echo base_url(); ?>/resources/img/compteur.png" media="(min-width: 992px)" /><img class="jarallax-img" src="<?php echo base_url(); ?>/resources/img/compteur.png" alt="img" />
                    </picture>
                </div>
    ...
    background-size: cover;">
                            <div class="row">
                                <div class="col-12" style="margin-left:25px;margin-top:50px">
                                    ...
                                    <p style="color: white;" id="devquote">Vivre, c'est aider à vivre. Il faut créer<br>d'autres bonheurs pour être heureux.<br></p>
                                </div>
                            </div>
                        </div>
